...
{
public const string SDL_KEYCODE = "SDL2.dll";


public static readonly uint SDLK_SCANCODE_MASK = (1<<30);
//public static readonly uint KMOD_CTRL = (KMOD_LCTRL|KMOD_RCTRL);
//public static readonly uint KMOD_SHIFT = (KMOD_LSHIFT|KMOD_RSHIFT);
//public static readonly uint KMOD_ALT = (KMOD_LALT|KMOD_RALT);
//public static readonly uint KMOD_GUI = (KMOD_LGUI|KMOD_RGUI);
public enum SDL_KEY 
{
	SDLK_UNKNOWN = 0,
	SDLK_RETURN = 13,
